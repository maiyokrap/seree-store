            ...
            <div class="card">
                ...
                <div class="card-body justify-content-center">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-1 row">
                            <label for="username" class="col-md-4 col-form-label text-end">{{ __('username') }}</label>
                        ...
                        <div class="mb-1 row">
                            <label for="first_name" class="col-md-4 col-form-label text-end">{{ __('firstname') }}</label>
                        ...
                        <div class="mb-1 row">
                            <label for="last_name" class="col-md-4 col-form-label text-end">{{ __('lastname') }}</label>
